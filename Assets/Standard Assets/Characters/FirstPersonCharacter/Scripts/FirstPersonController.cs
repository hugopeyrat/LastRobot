...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public void PauseMenu(bool arg)
        {
            ...
            Cursor.visible = arg;
            UI_Pause.SetActive(arg);
            UI_Jeu.SetActive(!arg);
        ...
        public void CoupPorte()
        {
            if(TriggerPorteFin.GetComponent<DoorManager>().ReturnIndent() == 1)
            {
                TriggerPorteFin.GetComponent<DoorManager>().SwitchPorte("UnCoup");
            }
            else if(TriggerPorteFin.GetComponent<DoorManager>().ReturnIndent() == 2)
            {
                TriggerPorteFin.GetComponent<DoorManager>().SwitchPorte("DeuxCoup");
            }
            else if (TriggerPorteFin.GetComponent<DoorManager>().ReturnIndent() == 3)
            {
                TriggerPorteFin.GetComponent<DoorManager>().SwitchPorte("Cassee");
            }
            else if (TriggerPorteFin.GetComponent<DoorManager>().ReturnIndent() > 3)
            {
                TriggerPorteFin.GetComponent<DoorManager>().SetIndent(3);
                TriggerPorteFin.GetComponent<DoorManager>().SwitchPorte("Cassee");
            }
        }
